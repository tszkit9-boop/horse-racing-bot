                ...
                if status == "pending":
                    ...
                    if plan != 'quarter':
                        if st.button("🔧 修正為季費", key=f"fix_quarter_{original_idx}"):
                            ...
                            rec['final_price'] = CONFIG['price_quarter']
                            save_payment_proofs(proofs_data)
