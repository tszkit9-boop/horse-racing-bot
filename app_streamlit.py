...
# ============================================================
CONFIG = {
    "enable_registration": False,   # True = 要註冊，False = 任何人都用得
    "enable_payment": False,        # True = 要俾錢，False = 全部免費
    "enable_admin": True,           # True = 管理員功能可見
    "currency": "HKD",
    "free_limit": 2,
    "subscription_price": 9.99,
    "admin_password": "admin54060437",
}
...
# ============================================================
# 4. 完整特徵工程（由 predict_race_card.py 移植）
# ============================================================
FEATURES_EN = [
...
# ============================================================
# 6. 登入/註冊、付費牆、管理後台（同上，此處省略）
# ============================================================
# ...（此部分同之前一樣，為節省篇幅，我假設你已有這些函數）
# 但為確保完整性，下面我將包含所有必要函數。
...
def main():
    ...
    st.caption("🔐 數據來源：HKJC | 系統版本：v9.0-完整預測+後台")
