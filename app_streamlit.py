...
# ============================================================
# 其餘你原本嘅程式碼（完全保留，由 load_users() 開始）
# ============================================================e
