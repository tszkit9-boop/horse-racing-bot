        ...
        >
          {!collapsed && (
            <>
              ...
              <span className="flex-1 font-semibold text-sm truncate text-sidebar-foreground">BotDeck</span>
            </>
          )}
          <Tooltip>
        ...
        >
          ...
          {collapsed ? (
            <Tooltip>
              ...
              <TooltipContent side="right">Alex Morgan · alex@northstar.team</TooltipContent>
            </Tooltip>
          ) : (
            <button className="flex items-center gap-2 rounded-md hover:bg-accent transition-colors cursor-pointer w-full px-2 py-1.5">
              ...
              <div className="flex-1 min-w-0 text-left">
                <p className="text-xs font-medium leading-tight truncate text-sidebar-foreground">Alex Morgan</p>
